...
const AVATARS: { key: AvatarType; title: string; desc: string; sprite: string }[] = [
  { key: 'planner', title: 'プランナー', desc: '計画を立てるのが得意', sprite: '/sprites/avatar-planner.png' },
  { key: 'explorer', title: 'エクスプローラー', desc: '好奇心旺盛な冒険家', sprite: '/sprites/avatar-explorer.png' },
  { key: 'crafter', title: 'クラフター', desc: 'ものづくりの達人', sprite: '/sprites/avatar-crafter.png' },
];
          ...
          {AVATARS.map((a) => {
            ...
            return (
              <button
                ...
                className={
                  'rounded-lg border-2 p-3 text-center transition-all focus-visible:outline-none focus-visible:ring-2 ' +
                  (active
              ...
              >
                <div className="relative mx-auto mb-2 h-24 w-16">
                  <Image
                    src={a.sprite}
                    alt={a.title}
                    fill
